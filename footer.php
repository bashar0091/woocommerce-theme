        ...
        <div class="row p-0 m-0">
          <div class="col-md-6 p-0 d-none d-md-block">
            <div class="newsletter-popup__bg h-100 w-100">
              <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/images/newsletter-popup.jpg" class="h-100 w-100 object-fit-cover d-block" alt="" />
            </div>
          </div>
  ...
  <!-- <script src="<?php echo get_template_directory_uri(); ?>/js/plugins/jquery.waypoints.min.js"></script> -->
