...
.report_box .box_1, .report_box .box_2 {
	padding: 15px 30px;
	border: 1px solid #000;
	margin-top: 30px;
    max-width: 535px;
...
<div class="report_cats">
    <ul>
        <li><a href="#">Today Report</a></li>
        <li><a href="#">Current Month Report</a></li>
...
<div class="report_box">
    <div class="box_1">
        <h2>Top Sell Product </h2>

        <table id="examplessss" class="examplessss" cellspacing="0" width="100%">
        <thead>          
          <tr>
                <th>Name</th>
                <th>Position</th>
