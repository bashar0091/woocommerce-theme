<?php get_header(); ?>
  ...
  <main>
    ...
    <section class="deal-timer position-relative d-flex align-items-end overflow-hidden" style="background-color: #ebebeb;">
      <div class="background-img" style="background-image: url('<?php echo get_template_directory_uri(); ?>/images/deal_timer_bg.jpg');"></div>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="grid-banner__item grid-banner__item_rect position-relative">
            <div class="background-img" style="background-image: url('<?php echo get_template_directory_uri(); ?>/images/banner_1.jpg');"></div>
        ...
        <div class="col-md-6">
          <div class="grid-banner__item grid-banner__item_rect position-relative">
            <div class="background-img" style="background-image: url('<?php echo get_template_directory_uri(); ?>/images/banner_2.jpg');"></div>
            <div class="content_abs content_bottom content_left content_bottom-lg content_left-lg">
    ...
    <div class="swiper-wrapper">
        <?php
        // Set up your query to get WooCommerce products
        $args = array(
            'post_type'      => 'product',
            ...
            <div class="swiper-slide product-card">
                <div class="pc__img-wrapper">
                    <a href="<?php echo esc_url($product_link); ?>">
                        <img loading="lazy" src="<?php echo esc_url($product_image[0]); ?>" width="330" height="400" alt="<?php echo esc_attr($product_title); ?>" class="pc__img">
                    </a>
                    <button class="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium js-add-cart js-open-aside" data-aside="cartDrawer" title="<?php esc_attr_e('Add To Cart', 'your-theme-textdomain'); ?>">Add To Cart</button>
                </div>

                <div class="pc__info position-relative">
                    <p class="pc__category"><?php echo esc_html__('Dresses', 'your-theme-textdomain'); ?></p>
                    <h6 class="pc__title"><a href="<?php echo esc_url($product_link); ?>"><?php echo esc_html($product_title); ?></a></h6>
                    <div class="product-card__price d-flex">
                        <span class="money price"><?php echo $product->get_price_html(); ?></span>
                    </div>

                    <button class="pc__btn-wl position-absolute top-0 end-0 bg-transparent border-0 js-add-wishlist" title="<?php esc_attr_e('Add To Wishlist', 'your-theme-textdomain'); ?>">
                        <svg width="16" height="16" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><use href="#icon_heart" /></svg>
                    </button>
                </div>
            </div>
